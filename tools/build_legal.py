...
PAGES = {
    "pricing.html": dict(
      ...
      <div class="product-licence" role="tabpanel" id="panel-sharecare" aria-labelledby="tab-sharecare" tabindex="0" style="--tone: var(--t-sharecare)">
        <header>
          <h3>ShareCare</h3>
          <p class="counted">Per Microsoft 365 user, per month &middot; 25-user minimum</p>
        </header>
        <div class="table-wrap table-scroll" tabindex="0">
          <table class="matrix">
            <thead>
              <tr><th scope="col">&nbsp;</th><th class="rung-head" scope="col">Visibility<small>see it</small></th><th class="rung-head" scope="col">Governance<small>govern it</small></th><th class="rung-head" scope="col">Automation<small>act on it</small></th></tr>
            </thead>
            <tbody>
      ...
      <div class="product-licence" role="tabpanel" id="panel-webscan" aria-labelledby="tab-webscan" tabindex="0" style="--tone: var(--t-webscan)">
        ...
        <div class="table-wrap table-scroll" tabindex="0">
          <table class="matrix">
            <thead>
              <tr><th scope="col">&nbsp;</th><th class="rung-head" scope="col">Free<small>on every tenant</small></th><th class="rung-head" scope="col">Pro<small>kept and scheduled</small></th></tr>
            </thead>
            <tbody>
        ...
        <p class="small dim">One paid licence, not a ladder &mdash; keeping a scan and scheduling it were separate rungs, and that sold a distinction nobody makes: a saved site nobody re-scans is a stale record, and a schedule that keeps nothing is a cron job with no output.</p>
        <div class="note plain">
      ...
      <div class="product-licence" role="tabpanel" id="panel-compliance" aria-labelledby="tab-compliance" tabindex="0" style="--tone: var(--t-compliance)">
        ...
        <div class="table-wrap table-scroll" tabindex="0">
          <table class="matrix">
            <thead>
              <tr><th scope="col">&nbsp;</th><th class="rung-head" scope="col">1 framework<small>single regime</small></th><th class="rung-head" scope="col">3 frameworks<small>the usual mix</small></th><th class="rung-head" scope="col">Unlimited<small>every regime</small></th></tr>
            </thead>
            <tbody>
        ...
        <div class="table-wrap table-scroll" tabindex="0">
          <table class="matrix">
            <thead>
              <tr><th scope="col">&nbsp;</th><th class="rung-head" scope="col">Price<small>per month</small></th></tr>
            </thead>
            <tbody>
      ...
      <ul>
        <li><strong>Which rung you buy.</strong> See <a href="licensing.html">what each licence includes</a>.</li>
