...
PAGES = {
    "pricing.html": dict(
      ...
      <div class="product-licence" role="tabpanel" id="panel-sharecare" aria-labelledby="tab-sharecare" tabindex="0" style="--tone: var(--t-sharecare)">
        ...
        <p class="after">The $99 platform minimum bites on Visibility up to 49 users and nowhere else &mdash; on the paid tiers the 25-user minimum already clears it. What each tier unlocks is on the <a href="licensing.html#sharecare">licensing page</a>.</p>
      </div>
